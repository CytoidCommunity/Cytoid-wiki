    ...
    <header class="hero">
      <div style="z-index: 1">
        ...
        <div class="guide-btn-box">
          <div v-if="data.subactionText && data.subactionLink" class="action">
            <NavLink class="subaction-button" :item="subactionLink" />
          </div>

          <div v-if="data.actionText && data.actionLink" class="action">
            <NavLink class="action-button" :item="actionLink" />
          </div>
        </div>
      </div>
      <div style="display: none" id="home-path" v-text="$page.path"></div>
    </header>
