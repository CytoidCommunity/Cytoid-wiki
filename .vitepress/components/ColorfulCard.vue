...
<template>
  <a
    class="tw-card tw-my-4 tw-bg-primary/25 tw-shadow !tw-no-underline !tw-text-base-content"
    :href="props.link"
    target="_blank"
  >
    <div class="tw-card-body">
      <div class="tw-card-title">
        {{ props.title }}
        <svg xmlns="http://www.w3.org/2000/svg" class="tw-h-4 tw-w-4" viewBox="0 0 24 24">
